...
export const _housesTitle = [
  'Room in Gdańsk',
  'Cozy Apartment near Old Town',
  'Modern Studio with Balcony',
  'Seaside Room with View',
  'Minimalist Loft in Downtown',
  'Old Town Apartment',
  'Quiet Room in City Center',
  'Stylish Flat with Terrace',
  'Budget Room near Train Station',
  'Luxury Apartment with Sauna',
  'Harbor View Studio',
  'Scandinavian Style Apartment',
  'Comfort Room with Private Bath',
  'Modern Flat near University',
  'Elegant Apartment in Wrzeszcz',
  'Bright Room with Shared Kitchen',
];

export const _housesHostType = [
  'Individual host',
  'Superhost',
  'Individual host',
  'Superhost',
...
export const _housesPricePerNight = [
  89, 95, 75, 120, 85, 110, 70, 130, 55, 160, 105, 115, 80, 90, 125, 65,
];

export const _housesTotalPrice = [
  89, 190, 150, 240, 170, 220, 140, 260, 110, 320, 210, 230, 160, 180, 250, 130,
];
